...
from format_parsing.ingestion import LogIngestionService
from format_parsing.staging import StagingArea
...
# -------------------------------------------------------------------
    ...
    # Write staging output to project root staging_area/
    staging_dir = Path(__file__).parent.parent / "staging_area"
    ...
    try:
        ...
        pass  # Ignore if can't delete, will try to overwrite
    ...
    try:
        ...
        print("  (This may be due to file permissions or existing files being open)")
